              ...
              <div className="flex gap-2">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="text-sm text-gray-300 hover:text-white bg-slate-800 rounded-xl px-4 py-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
